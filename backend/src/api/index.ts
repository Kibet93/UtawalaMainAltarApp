...
require('./accountabilityGroups').default(routes);
require('./services').default(routes);
require('./announcementTargets').default(routes);
require('./announcement').default(routes);
require('./serviceAttendance').default(routes);
require('./members').default(routes);
require('./homeFellowships').default(routes);
require('./reservedSeats').default(routes);
require('./calendar').default(routes);
require('./liveService').default(routes);
