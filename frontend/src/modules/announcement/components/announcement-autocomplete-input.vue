...
<script lang="ts">
import AnnouncementFormModal from '@/modules/announcement/components/announcement-form-modal.vue';
import { AnnouncementPermissions } from '@/modules/announcement/announcement-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-announcement-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-announcement-form-modal': AnnouncementFormModal,
  },
