<template>
  <div class="app-page-toolbar">
    ...
    <router-link
      :to="{
        path: '/audit-logs',
        query: { entityNames: 'announcement' },
      }"
...
export default Vue.extend({
  name: 'app-announcement-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'announcement/list/hasRows',
      loading: 'announcement/list/loading',
      exportLoading: 'announcement/list/exportLoading',
      selectedRows: 'announcement/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'announcement/list/doExport',
      doRemoveAllSelected:
        'announcement/list/doRemoveAllSelected',
      doDisableAllSelected:
        'announcement/list/doDisableAllSelected',
      doEnableAllSelected:
        'announcement/list/doEnableAllSelected',
      doDestroyAll: 'announcement/destroy/doDestroyAll',
    }),
