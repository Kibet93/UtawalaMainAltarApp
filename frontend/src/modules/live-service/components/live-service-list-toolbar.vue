...
export default Vue.extend({
  name: 'app-live-service-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'liveService/list/hasRows',
      loading: 'liveService/list/loading',
      exportLoading: 'liveService/list/exportLoading',
      selectedRows: 'liveService/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'liveService/list/doExport',
      doRemoveAllSelected:
        'liveService/list/doRemoveAllSelected',
      doDisableAllSelected:
        'liveService/list/doDisableAllSelected',
      doEnableAllSelected:
        'liveService/list/doEnableAllSelected',
      doDestroyAll: 'liveService/destroy/doDestroyAll',
    }),
