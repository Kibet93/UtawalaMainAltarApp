<template>
  <div class="app-page-toolbar">
    ...
    <router-link
      :to="{
        path: '/audit-logs',
        query: { entityNames: 'reservedSeats' },
      }"
...
export default Vue.extend({
  name: 'app-reserved-seats-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'reservedSeats/list/hasRows',
      loading: 'reservedSeats/list/loading',
      exportLoading: 'reservedSeats/list/exportLoading',
      selectedRows: 'reservedSeats/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'reservedSeats/list/doExport',
      doRemoveAllSelected:
        'reservedSeats/list/doRemoveAllSelected',
      doDisableAllSelected:
        'reservedSeats/list/doDisableAllSelected',
      doEnableAllSelected:
        'reservedSeats/list/doEnableAllSelected',
      doDestroyAll: 'reservedSeats/destroy/doDestroyAll',
    }),
