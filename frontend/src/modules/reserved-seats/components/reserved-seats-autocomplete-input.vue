...
<script lang="ts">
import ReservedSeatsFormModal from '@/modules/reserved-seats/components/reserved-seats-form-modal.vue';
import { ReservedSeatsPermissions } from '@/modules/reserved-seats/reserved-seats-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-reserved-seats-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-reserved-seats-form-modal': ReservedSeatsFormModal,
  },
