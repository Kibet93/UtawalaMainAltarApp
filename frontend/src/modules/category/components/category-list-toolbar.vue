...
export default Vue.extend({
  name: 'app-category-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'category/list/hasRows',
      loading: 'category/list/loading',
      exportLoading: 'category/list/exportLoading',
      selectedRows: 'category/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'category/list/doExport',
      doRemoveAllSelected:
        'category/list/doRemoveAllSelected',
      doDisableAllSelected:
        'category/list/doDisableAllSelected',
      doEnableAllSelected:
        'category/list/doEnableAllSelected',
      doDestroyAll: 'category/destroy/doDestroyAll',
    }),
