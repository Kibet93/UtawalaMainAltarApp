...
<script lang="ts">
import CategoryFormModal from '@/modules/category/components/category-form-modal.vue';
import { CategoryPermissions } from '@/modules/category/category-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-category-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-category-form-modal': CategoryFormModal,
  },
