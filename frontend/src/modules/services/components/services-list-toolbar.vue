...
export default Vue.extend({
  name: 'app-services-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'services/list/hasRows',
      loading: 'services/list/loading',
      exportLoading: 'services/list/exportLoading',
      selectedRows: 'services/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'services/list/doExport',
      doRemoveAllSelected:
        'services/list/doRemoveAllSelected',
      doDisableAllSelected:
        'services/list/doDisableAllSelected',
      doEnableAllSelected:
        'services/list/doEnableAllSelected',
      doDestroyAll: 'services/destroy/doDestroyAll',
    }),
