<template>
  <div style="display: flex;">
    ...
    ></el-button>
    <portal to="modal">
      <app-home-fellowships-form-modal
...
<script lang="ts">
import HomeFellowshipsFormModal from '@/modules/home-fellowships/components/home-fellowships-form-modal.vue';
import { HomeFellowshipsPermissions } from '@/modules/home-fellowships/home-fellowships-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-home-fellowships-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-home-fellowships-form-modal': HomeFellowshipsFormModal,
  },
