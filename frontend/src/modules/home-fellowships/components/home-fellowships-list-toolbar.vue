<template>
  <div class="app-page-toolbar">
    ...
    <router-link
      :to="{ path: '/home-fellowships/import' }"
    ...
    <router-link
      :to="{
        path: '/audit-logs',
        query: { entityNames: 'homeFellowships' },
      }"
...
export default Vue.extend({
  name: 'app-home-fellowships-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'homeFellowships/list/hasRows',
      loading: 'homeFellowships/list/loading',
      exportLoading: 'homeFellowships/list/exportLoading',
      selectedRows: 'homeFellowships/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'homeFellowships/list/doExport',
      doRemoveAllSelected:
        'homeFellowships/list/doRemoveAllSelected',
      doDisableAllSelected:
        'homeFellowships/list/doDisableAllSelected',
      doEnableAllSelected:
        'homeFellowships/list/doEnableAllSelected',
      doDestroyAll: 'homeFellowships/destroy/doDestroyAll',
    }),
