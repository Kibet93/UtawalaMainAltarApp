...
export default Vue.extend({
  name: 'app-announcement-targets-list-filter',
  ...
  computed: {
    ...mapGetters({
      ...
      rawFilter: 'announcementTargets/list/rawFilter',
    }),
  ...
  methods: {
    ...mapActions({
      doReset: 'announcementTargets/list/doReset',
      doFetch: 'announcementTargets/list/doFetch',
    }),
