<template>
  <div class="app-page-toolbar">
    <router-link
      :to="{ path: '/announcement-targets/new' }"
    ...
    <router-link
      :to="{ path: '/announcement-targets/import' }"
    ...
    <router-link
      :to="{
        path: '/audit-logs',
        query: { entityNames: 'announcementTargets' },
      }"
...
export default Vue.extend({
  name: 'app-announcement-targets-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'announcementTargets/list/hasRows',
      loading: 'announcementTargets/list/loading',
      exportLoading: 'announcementTargets/list/exportLoading',
      selectedRows: 'announcementTargets/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'announcementTargets/list/doExport',
      doRemoveAllSelected:
        'announcementTargets/list/doRemoveAllSelected',
      doDisableAllSelected:
        'announcementTargets/list/doDisableAllSelected',
      doEnableAllSelected:
        'announcementTargets/list/doEnableAllSelected',
      doDestroyAll: 'announcementTargets/destroy/doDestroyAll',
    }),
