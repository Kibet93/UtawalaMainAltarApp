...
import announcementTargetsListExporterFields from '@/modules/announcement-targets/announcement-targets-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (
          !announcementTargetsListExporterFields ||
          !announcementTargetsListExporterFields.length
        ) {
          throw new Error(
            'announcementTargetsListExporterFields is required',
          );
        }
        ...
        const response = await AnnouncementTargetsService.list(
          filter,
          getters.orderBy,
          null,
          null,
