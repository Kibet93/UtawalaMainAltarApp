...
import accountabilityGroupsListExporterFields from '@/modules/accountability-groups/accountability-groups-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (
          !accountabilityGroupsListExporterFields ||
          !accountabilityGroupsListExporterFields.length
        ) {
          throw new Error(
            'accountabilityGroupsListExporterFields is required',
          );
        }
        ...
        const response = await AccountabilityGroupsService.list(
          filter,
          getters.orderBy,
          null,
          null,
