<template>
  <div class="app-page-toolbar">
    <router-link
      :to="{ path: '/accountability-groups/new' }"
    ...
    <router-link
      :to="{ path: '/accountability-groups/import' }"
    ...
    <router-link
      :to="{
        path: '/audit-logs',
        query: { entityNames: 'accountabilityGroups' },
      }"
...
export default Vue.extend({
  name: 'app-accountability-groups-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'accountabilityGroups/list/hasRows',
      loading: 'accountabilityGroups/list/loading',
      exportLoading: 'accountabilityGroups/list/exportLoading',
      selectedRows: 'accountabilityGroups/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'accountabilityGroups/list/doExport',
      doRemoveAllSelected:
        'accountabilityGroups/list/doRemoveAllSelected',
      doDisableAllSelected:
        'accountabilityGroups/list/doDisableAllSelected',
      doEnableAllSelected:
        'accountabilityGroups/list/doEnableAllSelected',
      doDestroyAll: 'accountabilityGroups/destroy/doDestroyAll',
    }),
