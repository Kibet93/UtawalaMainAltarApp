  ...
  <div class="filter">
    ...
    >
      <el-row type="flex">
        ...
        <el-col :lg="12" :md="16" :sm="24">
          <el-form-item :label="fields.leader.label" :prop="fields.leader.name">
            <app-autocomplete-one-input
...
export default Vue.extend({
  name: 'app-accountability-groups-list-filter',
  ...
  computed: {
    ...mapGetters({
      ...
      rawFilter: 'accountabilityGroups/list/rawFilter',
    }),
  ...
  methods: {
    ...mapActions({
      doReset: 'accountabilityGroups/list/doReset',
      doFetch: 'accountabilityGroups/list/doFetch',
    }),
