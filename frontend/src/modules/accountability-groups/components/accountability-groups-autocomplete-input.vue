<template>
  <div style="display: flex;">
    ...
    ></el-button>
    <portal to="modal">
      <app-accountability-groups-form-modal
...
<script lang="ts">
import AccountabilityGroupsFormModal from '@/modules/accountability-groups/components/accountability-groups-form-modal.vue';
import { AccountabilityGroupsPermissions } from '@/modules/accountability-groups/accountability-groups-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-accountability-groups-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-accountability-groups-form-modal': AccountabilityGroupsFormModal,
  },
