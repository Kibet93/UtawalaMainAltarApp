...
<script lang="ts">
import CalendarFormModal from '@/modules/calendar/components/calendar-form-modal.vue';
import { CalendarPermissions } from '@/modules/calendar/calendar-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-calendar-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-calendar-form-modal': CalendarFormModal,
  },
