...
export default Vue.extend({
  name: 'app-calendar-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'calendar/list/hasRows',
      loading: 'calendar/list/loading',
      exportLoading: 'calendar/list/exportLoading',
      selectedRows: 'calendar/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'calendar/list/doExport',
      doRemoveAllSelected:
        'calendar/list/doRemoveAllSelected',
      doDisableAllSelected:
        'calendar/list/doDisableAllSelected',
      doEnableAllSelected:
        'calendar/list/doEnableAllSelected',
      doDestroyAll: 'calendar/destroy/doDestroyAll',
    }),
