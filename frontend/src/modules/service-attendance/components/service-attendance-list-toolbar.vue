<template>
  <div class="app-page-toolbar">
    <router-link
      :to="{ path: '/service-attendance/new' }"
    ...
    <router-link
      :to="{ path: '/service-attendance/import' }"
    ...
    <router-link
      :to="{
        path: '/audit-logs',
        query: { entityNames: 'serviceAttendance' },
      }"
...
export default Vue.extend({
  name: 'app-service-attendance-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'serviceAttendance/list/hasRows',
      loading: 'serviceAttendance/list/loading',
      exportLoading: 'serviceAttendance/list/exportLoading',
      selectedRows: 'serviceAttendance/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'serviceAttendance/list/doExport',
      doRemoveAllSelected:
        'serviceAttendance/list/doRemoveAllSelected',
      doDisableAllSelected:
        'serviceAttendance/list/doDisableAllSelected',
      doEnableAllSelected:
        'serviceAttendance/list/doEnableAllSelected',
      doDestroyAll: 'serviceAttendance/destroy/doDestroyAll',
    }),
