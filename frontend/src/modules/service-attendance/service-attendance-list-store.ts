...
import serviceAttendanceListExporterFields from '@/modules/service-attendance/service-attendance-list-exporter-fields';
...
export default {
  ...
  actions: {
    ...
    async doExport({ commit, getters }) {
      try {
        if (
          !serviceAttendanceListExporterFields ||
          !serviceAttendanceListExporterFields.length
        ) {
          throw new Error(
            'serviceAttendanceListExporterFields is required',
          );
        }
        ...
        const response = await ServiceAttendanceService.list(
          filter,
          getters.orderBy,
          null,
          null,
