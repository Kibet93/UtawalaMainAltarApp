...
<script lang="ts">
import MembersFormModal from '@/modules/members/components/members-form-modal.vue';
import { MembersPermissions } from '@/modules/members/members-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-members-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-members-form-modal': MembersFormModal,
  },
