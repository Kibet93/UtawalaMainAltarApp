...
export default Vue.extend({
  name: 'app-members-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'members/list/hasRows',
      loading: 'members/list/loading',
      exportLoading: 'members/list/exportLoading',
      selectedRows: 'members/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'members/list/doExport',
      doRemoveAllSelected:
        'members/list/doRemoveAllSelected',
      doDisableAllSelected:
        'members/list/doDisableAllSelected',
      doEnableAllSelected:
        'members/list/doEnableAllSelected',
      doDestroyAll: 'members/destroy/doDestroyAll',
    }),
